...
export default function Header() {
  ...
  return (
    <header>
      ...
      >
        <div className='flex flex-col leading-none justify-end w-full lg:w-1/2'>
          <h1 className='text-accent text-[1.5rem]'>currently...</h1>
          {nowPlaying.playing ? (
            <a
              href={nowPlaying.url}
              target='_blank'
              rel='noopener noreferrer'
              className='flex items-center gap-3 mt-2 w-fit hover:opacity-50 transition-opacity'
            >
            ...
            <span className='text-background text-[1.5rem] mt-2'>looking for song recommendations</span>
          )}
        </div>
